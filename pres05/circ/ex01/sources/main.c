    ...
    do{
        ...
        switch(operador){
            ...
            case 3:
                ...
                printf("Remocao do primeiro elemento requisitada\n");

                retorno = removeInicio(&lst, &output);
                if(retorno == 0){
                    printf("Lista Vazia\nFalha ao remover elemento\n");
                }
                else if(retorno == 1){
                    printf("Sucesso ao remover o elemento %d do comeco da lista\n", output);
                }
            break;
